...
export default function CreateCartonPage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    const trimmed = {
      ...
      billedAmount: form.billedAmount.trim(),
    ...
    try {
      ...
      const res = await fetch(endpoint, {
        ...
        body: JSON.stringify({
          ...
          billedAmount: trimmed.billedAmount
            ? Number(trimmed.billedAmount)
            : undefined,
      ...
      setMessage(
        isEditing
          ? "Carton updated successfully."
          : "Carton created successfully."
      );
      if (!isEditing) {
        setForm({
          cartonNo: "",
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Row entry — move left to right, then{" "}
                  {isEditing ? "save changes" : "hit Add"}.
                </p>
              </div>
                    ...
                    <tr className="bg-card">
                      ...
                      <td className="border border-border px-2 py-2">
                        <div className="grid gap-2 sm:grid-cols-2">
                          <Input
                            ...
                            value={form.cartonNo}
                            onChange={(e) =>
                              setForm({ ...form, cartonNo: e.target.value })
                            }
                            placeholder="Printed #"
                            className="h-9"
                          />
                      ...
                      <td className="border border-border px-2 py-2">
                        <Input
                          value={form.packNo}
                          onChange={(e) =>
                            setForm({ ...form, packNo: e.target.value })
                          }
                          placeholder="PK-01"
                          className="h-9"
                        />
                      ...
                      <td className="border border-border px-2 py-2">
                        <Input
                          ...
                          value={form.unitPcs}
                          onChange={(e) =>
                            setForm({ ...form, unitPcs: e.target.value })
                          }
                          placeholder="100"
                          className="h-9"
                        />
                    ...
                    <tr className="bg-muted/20">
                      ...
                      <td className="border border-border px-2 py-2">
                        <Input
                          ...
                          value={form.cbm}
                          onChange={(e) =>
                            setForm({ ...form, cbm: e.target.value })
                          }
                          placeholder="CBM"
                          className="h-9"
                        />
                      ...
                      <td className="border border-border px-2 py-2">
                        ...
                        >
                          <Input
                            ...
                            onChange={(e) =>
                              setForm({ ...form, billedAmount: e.target.value })
                            }
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h2 className="text-lg font-semibold">
              Confirm carton for box request
            </h2>
          </div>
